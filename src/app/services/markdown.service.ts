...
export class MarkdownService {
  ...
  Build(state: EditorState) {
    const sections = [
      ...
      state.npm.badges &&
        this.generateNpmBadges(state.npm.package!, {
          npmVersion: {
            color: '0470FF',
            logoColor: 'white',
          },
  ...
  test() {
    ...
    const githubRepo = 'readme-wizard';
    ...
    const images = [{ url: 'https://placehold.co/600x400', alt: 'Image 1' }];
...
This project was created by ${
      author.name
    }. Connect with me on [GitHub](https://github.com/${author.github}) ${
      author.likedIn
        ? `and [LinkedIn](https://www.linkedin.com/in/${author.likedIn}/)`
        : ''
